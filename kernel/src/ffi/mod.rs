...
use crate::client::{json::JsonReadContext, parquet::ParquetReadContext, DefaultTableClient};
...
#[no_mangle]
pub unsafe extern "C" fn get_table_with_default_client(path: *const c_char) -> *mut DefaultTable {
